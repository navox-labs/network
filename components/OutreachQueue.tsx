          ...
          return (
            ...
            >
              ...
              <div style={{ padding: isMobile ? "12px" : "14px 16px", display: "flex", gap: isMobile ? 10 : 14, alignItems: "flex-start", flexWrap: isMobile ? "wrap" : "nowrap" }}>
                ...
                <div style={{ display: "flex", gap: 6, flexShrink: 0, alignItems: "center", width: isMobile ? "100%" : "auto", justifyContent: isMobile ? "flex-end" : "flex-start", flexWrap: "wrap" }}>
                  <button
                  ...
                  >
                    <Copy size={12} />
                    {copiedId === conn.id ? "Copied!" : "Copy Info"}
                  </button>
                  <button
                    onClick={() => window.open(conn.url || linkedInSearch(conn.name), "_blank", "noopener,noreferrer")}
                    className="btn btn-ghost"
                    style={{ padding: "5px 10px", fontSize: 11, display: "flex", alignItems: "center", gap: 4 }}
                  >
